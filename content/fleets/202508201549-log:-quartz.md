...
I'd been inspired by [Eilleen's Guestbook](https://quartz.eilleeenz.com/) for a
while now and wanted to implement my own. At first I thought it was going to be
more involved, so it was in the backburner for a while because the HG Game Jam
was starting and I wanted to focus on that. 

> [!NOTE] [plug, plug, plug](https://www.youtube.com/watch?v=DVFDL_GBdBk)
> 
...
Now that I'm free (finally!), I wanted to go back and tend to my abandoned
garden. Honestly was bracing myself for an involved implementation, I thought I
had to roll out my own comments. Turns out, Quartz already has a builtin
`Comments` component. (I love devs <3)

🥳🥳🥳 Yippee!! 🥳🥳🥳

> [!INFO] For anyone curious, check out the [Quartz docs/comments](https://quartz.jzhao.xyz/features/comments). 
...
> I didn't like how the bullet points looked on the landing page. It was a good
placeholder, but it looked... dry.

![quartz-log-06.png](assets/quartz-log-06.png)

#### After

> So, I changed it! I got some inspiration from Socratica's Toolbox site,[^2]

![quartz-log-07.png](assets/quartz-log-07.png)

![quartz-log-08.png](assets/quartz-log-08.png)

**Hooray for cards!** I'm using util classes, it surprisingly doesn't take much
to just put the HTML in the Markdown, but I can definitely see that it might
get painful in the long run. For now, it'll suffice.
...
I saw a really cool site from the Quartz Showcase and I wanted to imitate them,[^1]
but... Adding a next button is getting bigger and more complicated than I
initially thought. 
...
[^1]: [[202508201325-cool-quartz-next-button|📝 cool quartz next button]]
